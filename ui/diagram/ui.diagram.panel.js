...
var DiagramPanel = function(_Widget) {
    ...
    _createClass(DiagramPanel, [{
        ...
        value: function() {
            var _this = this;
            _events_engine2.default.off(this._getPointerUpElement(), POINTERUP_EVENT_NAME);
            _events_engine2.default.on(this._getPointerUpElement(), POINTERUP_EVENT_NAME, function(e) {
